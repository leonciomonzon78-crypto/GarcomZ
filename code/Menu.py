...
class Menu:
    def __init__(self,window):
        self.window = window
        self.surf = pygame.image.load('./asset/MenuInicio.png').convert_alpha()
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(text_size=100,text="COMEÇAR",text_color=C_YELLOW,text_center_pos=(WIN_WIDTH // 2, 370))
            pygame.display.flip()
